...
//function phptemplate_links($links=array(), $attribs=array()) {
//  $output = '';
//  $links['view_gallery'] = array(
//    'title' => t('View Gallery'),
//    'href' => 'view_gallery/'.arg(1),
//    'attributes' => array(
//      'title' => 'View photo gallery associated with this node.'
//    ),
//    
//  );
//  $output .= '<div class="links"><ul class="links inline">';
//  foreach($links as $link) {
//    $output .= '<li class="comment_add first last"><a title="'.$link['attributes']['title'].'" href="'.url($link['href'], array('fragment'=>$link['fragment'])).'">'.$link['title'].'</a></li>';
//  }
//  
//  $output .= '</ul></div>';
//  
